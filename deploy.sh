...
SERVER_PATH="/yangruoji/weather_duck"
NGINX_CONF_PATH="/etc/nginx/conf.d/weather_duck.conf"
...
echo "1. 访问 https://yangruoji.com 验证部署"
...
echo "- 生产环境: https://yangruoji.com"
echo "- 清除 SW: https://yangruoji.com?reset-sw"
echo ""
echo "Happy coding! 🦆"
